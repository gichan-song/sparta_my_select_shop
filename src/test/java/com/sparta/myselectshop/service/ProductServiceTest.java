...
class ProductServiceTest {
    ...
    void test1() {
        ...
        given(productRepository.findById(productId.intValue())).willReturn(Optional.of(product));

        // when
        ProductResponseDto result = productService.updateProduct(productId.intValue(), requestMyPriceDto);
    ...
    void test2() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            productService.updateProduct(productId.intValue(), requestMyPriceDto);
        });
